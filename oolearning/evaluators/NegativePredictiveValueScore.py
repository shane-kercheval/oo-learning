...
class NegativePredictiveValueScore(UtilityFunctionMixin, ScoreActualPredictedBase):
    ...
    def _calculate(self,
        ...
        return TwoClassConfusionMatrix(actual_classes=actual_values,
                                       ...
                                       positive_class=self._converter.positive_class).negative_predictive_value  # noqa
